//=============================================================================
// main.js (Source Project Version)
//=============================================================================
...
//=============================================================================
// Universal Master Block (Auto-Detects Web vs EXE vs APK)
//=============================================================================
(function() {
    var checkReady = setInterval(function() {
        if (typeof AudioManager === 'undefined' || typeof SceneManager === 'undefined') return;
        clearInterval(checkReady);

        var isNativeApp = (typeof nw !== 'undefined') || (typeof cordova !== 'undefined');
        ...
        if (!isNativeApp) {
            ...
            // 💻 EXE / 📱 APK NATIVE APP: Use default .ogg and WebAudio for seamless looping
            AudioManager.shouldUseHtml5Audio = function() { return false; };
            AudioManager._shouldUseHtml5 = false;
            console.log("Native App Detected: Using default .ogg and WebAudio.");
        }

        // Smart Touch Fix (Applies to APK and Mobile Web)
        if (isTouchDevice) {
            var touchCheck = setInterval(function() {
                ...
                function clearDestination() {
                    if ($gameTemp && typeof $gameTemp.clearDestination === 'function') $gameTemp.clearDestination();
                }
                ...
                document.addEventListener('touchmove', function(e) {
                    if (e.touches.length === 1) {
                        ...
                        if (Math.sqrt(dx*dx + dy*dy) > 15) clearTimeout(longPressTimer);
                    }
                }, { passive: true });
